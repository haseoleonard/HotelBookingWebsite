 ...
 * @author haseo
 */
public abstract class MailHelpers {
...
//        if(MAIL_USER.trim().isEmpty()||MAIL_PASSWORD.trim().isEmpty())return;
        ...
        message.setSubject("[LAB231]-[HotelBooking] Reset Password");
        message.setContent("<h1 style='style=color:Blue'>Congratulations</h1>"
                ...
                + "Please Enter your code to complete the process.<br/>"
                + "If it's not you please ignore this message", "text/html");
