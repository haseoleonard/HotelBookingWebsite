 ...
 * @author haseo
 */
@WebServlet(name = "SendResetPasswordEmailController", urlPatterns = {"/SendResetPasswordEmailController"})
public class SendResetPasswordEmailController extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(SendResetPasswordEmailController.class);
    /**
